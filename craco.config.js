/*
 * @Descripttion:craco配置（扩展 create-react-app 的配置的）
 * @version:
 * @Author: zhoukai
...
// 移除console
const removeConsole = process.env.REACT_APP_REMOVE_CONSOLE === 'true';
                ...
                webpackConfig.optimization.minimizer = [
                    ...
                    new TerserPlugin({
                        ...
                        terserOptions: {
                            ...
                            compress: {
                                drop_console: removeConsole, // 生产环境下移除控制台所有的内容
                                drop_debugger: false, // 移除断点
                                pure_funcs: removeConsole ? ['console.log'] : [] // 生产环境下移除console
                            }
                        }
                    })
                ];
